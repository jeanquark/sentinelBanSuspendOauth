...
class Sentinel
{
    ...
    public function register(array $credentials, $callback = null)
    {
        ...
        if ($callback === true) { // On site registration
            //$this->activate($user);
            // CHANGES APPLIES FROM HERE ON J-M
    ...
    /**
     * Returns the suspensions repository.
     *
     * @return \Cartalyst\Sentinel\Suspensions\SuspensionRepositoryInterface
     */
    ...
    /**
     * Sets the suspensions repository.
     *
     * @param  \Cartalyst\Sentinel\Suspensions\SuspensionRepositoryInterface  $suspensions
     * @return void
     */
    ...
    /**
     * Returns the bans repository.
     *
     * @return \Cartalyst\Sentinel\Bans\BanRepositoryInterface
     */
